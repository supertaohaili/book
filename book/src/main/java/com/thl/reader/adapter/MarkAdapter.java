...
public class MarkAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(com.thl.reader.R.layout.item_bookmark, null);
            viewHolder.text_mark = (TextView) convertView.findViewById(com.thl.reader.R.id.text_mark);
            viewHolder.progress1 = (TextView) convertView.findViewById(com.thl.reader.R.id.progress1);
            viewHolder.mark_time = (TextView) convertView.findViewById(com.thl.reader.R.id.mark_time);
